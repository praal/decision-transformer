...
from transformers.models.decision_transformer.modeling_decision_transformer import DecisionTransformerGPT2Model, DecisionTransformerPreTrainedModel, DecisionTransformerOutput
...
from .causal_dt_config import CausalDecisionTransformerConfig
...
@add_start_docstrings("The Causal Decision Transformer Model v1", DECISION_TRANSFORMER_START_DOCSTRING)
class CausalDecisionTransformerModelV1(DecisionTransformerPreTrainedModel):
    """
    The model builds upon the GPT2 architecture to perform autoregressive prediction of actions in an offline RL
    setting. Refer to the paper for more details: https://arxiv.org/abs/2106.01345
    """

    def __init__(self, config: CausalDecisionTransformerConfig):
        ...
        self.embed_causal_structure = torch.nn.Linear(config.causal_structure_dim, config.hidden_size)
    ...
    def forward(
        ...
        # causal_structure(0), returns (1), states (2), or actions (3); i.e. x[:,1,t] is the token for s_t
...
class CausalDecisionTransformerModelV2(DecisionTransformerPreTrainedModel):
    """
    The model builds upon the GPT2 architecture to perform autoregressive prediction of actions in an offline RL
    setting. Refer to the paper for more details: https://arxiv.org/abs/2106.01345
    """
    ...
    def forward(
        ...
        # time and causal strucute embeddings treated similar to positional embeddings
        state_embeddings = state_embeddings + time_embeddings + causal_structure_embeddings
        action_embeddings = action_embeddings + time_embeddings + causal_structure_embeddings
        returns_embeddings = returns_embeddings + time_embeddings + causal_structure_embeddings
